...
class UrHandler:
    ...
    def f_move_1d(self, direction=None, force_threshold=2, step=0.0001):
        """
    ...
    def f_move_2d(self, move_direction, move_distance, force_direction, force_magnitude):
        ...
        self.control_handler.forceMode(current_position[:3], [0, 0, 0], force_vector, 2, selection_vector,
                                       limits)
...
def main() -> None:
    ...
    #     # Start logging data
    #     ur_handle.start_logging()
    #     threading.Thread(target=ur_handle.plot_ft_live).start()
    #
